...
let configuracaoErrada: Config = new Config();
...
let configuracaoMetade: Config = new Config();
...
let configuracaoCompleta: Config = new Config();
...
$("body").append(
  $("<p>",{text:"Criando esse parágrafo com Jquery."})
)